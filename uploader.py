...
from uploader_core.network import get_network_io, get_system_network_io
from uploader_core.udp import multi_udp_uploader
from uploader_core.ip import cache_ip_ports_from_database
from uploader_core.time import get_now_hour
from uploader_core.log import store_restart_uploader_uploader_log, store_new_upload_loop_log
...
store_restart_uploader_uploader_log()
