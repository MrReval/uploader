...
from uploader_menu import main_menu, display, monitor
from uploader_core.network import get_size, get_system_download, get_system_upload, get_system_network_io
